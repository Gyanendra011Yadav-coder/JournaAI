...
export default function LoginPage() {
  ...
  return (
    <div className="flex min-h-[calc(100vh-6rem)] items-center justify-center">
      <div className="grid w-full max-w-5xl gap-8 rounded-[32px] border border-slate-200/70 bg-white/90 p-8 shadow-[0_25px_60px_-45px_rgba(15,23,42,0.25)] lg:grid-cols-[1.1fr_0.9fr]">
        <div className="relative overflow-hidden rounded-2xl border border-slate-200/70 bg-gradient-to-br from-white via-slate-50 to-cyan-50 p-8">
          ...
          <div className="relative space-y-6">
            ...
            <h1 className="text-3xl font-semibold text-slate-900">PR News & Outreach</h1>
